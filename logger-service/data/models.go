...
func (l *LogEntry) Insert(entry LogEntry) error {
	...
	if err != nil {
		log.Panicln("Error inserting log entry", err)
		return err
	}
...
func (l *LogEntry) GetAll() ([]*LogEntry, error) {
	...
	if err != nil {
		log.Panicln("Error getting all log entries", err)
		return nil, err
	}
	...
	defer func(cursor *mongo.Cursor, ctx context.Context) {
		...
		if err != nil {
			log.Panicln("Error closing cursor", err)
		}
	}(cursor, ctx)
	...
	for cursor.Next(ctx) {
		...
		if err != nil {
			log.Panicln("Error decoding entry", err)
			return nil, err
		}
